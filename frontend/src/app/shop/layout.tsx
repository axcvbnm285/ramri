...
import { ShopThemeProvider } from "@/components/providers/ShopThemeProvider";

export default function ShopLayout({ children }: { children: React.ReactNode }) {
  return (
    <ShopThemeProvider>
      <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-gradient-to-b from-orange-100 via-amber-50/60 to-white dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 dark:text-gray-100">
