    ...
    return (
      <div className="w-full max-w-md rounded-2xl p-8 text-center">
        ...
        <p className="mt-3 text-gray-500">
          If that phone number is registered and has an email on file, we&apos;ve sent a link to
          reset your password.
        </p>
  ...
  return (
    <div className="w-full max-w-md rounded-2xl p-8">
      ...
      <p className="mt-2 text-gray-500">
        Enter your phone number and we&apos;ll email a reset link to the address on file.
      </p>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        Remembered it?{" "}
        <Link href="/shop/login" className="font-semibold text-[#7A2436] hover:underline">
          Back to login
        </Link>
      </p>
    </div>
